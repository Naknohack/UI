...
local dungeon = 73902483975735 --  th�m
...
elseif placeId == dungeon then
    CheckSea = "Sea 3" --  FIX: gi l�m Sea 3  UI chy
...
elseif placeId == 73902483975735 then
    ...
    warn("⚠️ World not recognized (No Kick)")
end
...
QuestNeta = function()
    ...
    Title = "NakHub V4",
    SubTitle = "Blox Fruit",
    SaveFolder = "Ngày Ra Mắt 28/7/2026"
})
-- Criar ScreenGui
