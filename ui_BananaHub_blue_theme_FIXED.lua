...
local T1UIColor = {
    ["Border Color"] = Color3.fromRGB(40, 90, 120),

    ["Click Effect Color"] = Color3.fromRGB(0, 170, 255),
    ["Setting Icon Color"] = Color3.fromRGB(200, 230, 255),
    ["Logo Image"] = "rbxassetid://100306458933414",

    ["Search Icon Color"] = Color3.fromRGB(0, 170, 255),
    ["Search Icon Highlight Color"] = Color3.fromRGB(80, 200, 255),

    ["GUI Text Color"] = Color3.fromRGB(220, 240, 255),
    ["Text Color"] = Color3.fromRGB(220, 240, 255),
    ["Placeholder Text Color"] = Color3.fromRGB(150, 190, 210),
    ["Title Text Color"] = Color3.fromRGB(255, 255, 255),

    ["Background Main Color"] = Color3.fromRGB(10, 25, 35),
    ["Background 1 Color"] = Color3.fromRGB(15, 35, 50),
    ["Background 1 Transparency"] = 0.25,
    ["Background 2 Color"] = Color3.fromRGB(20, 45, 65),
    ["Background 3 Color"] = Color3.fromRGB(18, 40, 55),
    ["Background Image"] = "",

    ["Page Selected Color"] = Color3.fromRGB(0, 170, 255),
    ["Section Text Color"] = Color3.fromRGB(200, 230, 255),
    ["Section Underline Color"] = Color3.fromRGB(0, 170, 255),

    ["Toggle Border Color"] = Color3.fromRGB(60, 120, 160),
    ["Toggle Checked Color"] = Color3.fromRGB(0, 170, 255),
    ["Toggle Desc Color"] = Color3.fromRGB(170, 210, 230),

    ["Button Color"] = Color3.fromRGB(20, 50, 70),
    ["Label Color"] = Color3.fromRGB(18, 45, 65),
    ...
    ["Slider Line Color"] = Color3.fromRGB(40, 80, 100),
